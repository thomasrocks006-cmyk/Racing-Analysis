# Advanced Agent Skills - Complete ✅

## What's New

You now have **10 specialized skills** instead of 5 - including 5 powerful advanced skills for creative thinking, critical analysis, optimization, architecture, and security.

---

## Original 5 Core Skills (Unchanged)
...
- Generates 5-10 genuine alternatives
...
3. Use architecture-design skill: Evaluate and design new architecture
4. Use security-risk skill: Threat model new architecture
5. Use testing-qa skill: Plan testing strategy
```
...
3. Use model-development skill: Engineer and test features
4. Use performance-optimization skill: Optimize for speed
5. Use deep-critical-analysis skill: Critique effectiveness
```
...
3. Use creativity skill: Brainstorm unconventional optimizations
4. Use architecture-design skill: Design optimized architecture
5. Use testing-qa skill: Benchmark improvements
```

---

## Skill Matrix: When to Use Each

| Need | Skill | Workflow |
|------|-------|----------|
| **Novel solution?** | Creativity | Brainstorm → Evaluate → Select |
| **Thorough review?** | Deep Critical | Layer 1-4 analysis + checkpoints |
| **Too slow?** | Performance | Profile → Diagnose → Optimize |
| **Design system?** | Architecture | Options → Evaluate → Document |
| **Security concern?** | Security | Threat model → Assess → Mitigate |

---

## Key Differences: Advanced vs Core Skills

| Aspect | Core Skills | Advanced Skills |
|--------|------------|-----------------|
| **Purpose** | Implement features | Think deeply & critically |
| **Workflow** | Direct (do the thing) | Multi-layered (analyze thoroughly) |
| **Output** | Code/features/tests | Insights/plans/recommendations |
| **Time** | Hours/days | Hours for analysis |
| **Rigor** | Standard | Extra thoroughness |
| **When to Use** | Daily work | Critical decisions |

---

## Example Session: Using All 10 Skills
...
Use architecture-design skill: Design the scraper architecture.
Evaluate GraphQL vs REST vs websockets.

Use security-risk skill: Threat model the Betfair integration.
```
...
Use performance-optimization skill: Optimize for speed.
...
Use deep-critical-analysis skill: Review everything for gaps.
Do gap analysis, test assumptions, ask tough questions.

Use analysis-insights skill: Generate report on scraper quality.
```
...
```
.github/AGENT_SKILLS/
├── README.md (main index - UPDATED with all 10 skills)
├── creativity-innovation.md ⭐ NEW
├── deep-critical-analysis.md ⭐ NEW
├── performance-optimization.md ⭐ NEW
├── architecture-design.md ⭐ NEW
├── security-risk-management.md ⭐ NEW
├── data-engineering.md (original)
├── model-development.md (original)
├── analysis-insights.md (original)
├── integration-orchestration.md (original)
└── testing-qa.md (original)
```
...
1. **Read the new skill files** - Each has complete workflows and code patterns
2. **Try them in your next session** - Start with Creativity or Deep Critical Analysis
3. **Reference the README** - Updated with all 10 skills and combination workflows
4. **Use multi-skill workflows** - Combine skills for complex tasks
5. **Update SESSION_NOTES.md** - Track what you learn about using new skills
...
```
Use creativity skill: What's one thing we haven't thought of?
```
